...
def restock_email(email_sender, password, email_receiver, subject, message):
    """
...
if __name__ == '__main__':
    email_sender = 'xyz@gamil.com'
    password = 'app_password' 
    email_receiver = 'xyz@gmail.com'
    subject = 'Rectock Alert'
    message = 'restock items'

    restock_email(email_sender, password, email_receiver, subject, message)